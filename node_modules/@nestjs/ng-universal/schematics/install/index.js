...
function addFiles(options) {
    return (tree, _context) => __awaiter(this, void 0, void 0, function* () {
        const browserDistDirectory = yield utils_1.getOutputPath(tree, options.project, 'build');
        const rule = schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files/root'), [
            schematics_1.template(Object.assign(Object.assign(Object.assign({}, core_1.strings), options), { stripTsExtension: (s) => s.replace(/\.ts$/, ''), getBrowserDistDirectory: () => browserDistDirectory, getServerDistDirectory: () => SERVER_DIST, getClientProjectName: () => options.project })),
